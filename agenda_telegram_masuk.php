    ...
    if(empty($_SESSION['admin'])){
        ...
        if(isset($_REQUEST['submit'])){
            ...
            if($_REQUEST['dari_tanggal'] == "" || $_REQUEST['sampai_tanggal'] == ""){
                header("Location: ./admin.php?page=atm");
                die();
            } else {

                $query = mysqli_query($config, "SELECT * FROM tbl_telegram_masuk WHERE tgl_diterima BETWEEN '$dari_tanggal' AND '$sampai_tanggal'");
                ...
                echo '
                            ...
                            <div class="z-depth-1">
                                <nav class="secondary-nav">
                                    <div class="nav-wrapper blue-grey darken-1">
                                        <div class="col 12">
                                            <ul class="left">
                                                <li class="waves-effect waves-light"><a href="?page=atm" class="judul"><i class="material-icons">print</i> Cetak Agenda Telegram Masuk<a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </nav>
                    ...
                    <div class="row agenda">
                        <div class="col s10">
                            ...
                            <h5 class="hid">AGENDA TELEGRAM MASUK</h5>';
                            ...
                            <p class="warna agenda">Agenda Telegram Masuk dari tanggal <strong>'.$d." ".$nm." ".$y.'</strong> sampai dengan tanggal <strong>'.$d2." ".$nm2." ".$y2.'</strong></p>
                        </div>
                        <div class="col s2">
                        ...
                        <table class="bordered" id="tbl" width="100%">
                            <thead class="blue lighten-4">
                                <tr>
                                    ...
                                    <th width="18%">Asal Telegram</th>
                                    <th width="15%">Nomor Telegram</th>
                                    <th width="8%">Tanggal<br/> Telegram</th>
                            ...
                            if(mysqli_num_rows($query) > 0){
                                ...
                                while($row = mysqli_fetch_array($query)){
                                 echo '
                                        ...
                                        <td>'.$row['kode'].'</td>
                                        <td>'.$row['isi'].'</td>
                                        <td>'.$row['asal_telegram_masuk'].'</td>
                                        <td>'.$row['no_telegram_masuk'].'</td>';
                                ...
                                echo '<tr><td colspan="9"><center><p class="add">Tidak ada agenda telegram masuk</p></center></td></tr>';
                            } echo '
                        </table>
                    </div>';
            }
                        ...
                        <div class="z-depth-1">
                            <nav class="secondary-nav">
                                <div class="nav-wrapper blue-grey darken-1">
                                    <div class="col 12">
                                        <ul class="left">
                                            <li class="waves-effect waves-light"><a href="?page=ask" class="judul"><i class="material-icons">print</i> Cetak Agenda Telegram Masuk<a></li>
                                        </ul>
                                    </div>
                                </div>
                            </nav>
