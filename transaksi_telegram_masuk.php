                        ...
                        <div class="z-depth-1">
                            <nav class="secondary-nav">
                                <div class="nav-wrapper blue-grey darken-1">
                                    <div class="col m7">
                                        <ul class="left">
                                            <li class="waves-effect waves-light hide-on-small-only"><a href="?page=tsm" class="judul"><i class="material-icons">mail</i> Telegram Masuk</a></li>
                        ...
                        <table class="bordered" id="tbl">
                            <thead class="blue lighten-4" id="head">
                                <tr>
                                    ...
                                    <th width="24%">Asal Telegram Masuk</th>
                            ...
                            <table class="bordered" id="tbl">
                                <thead class="blue lighten-4" id="head">
                                    <tr>
                                        ...
                                        <th width="30%">Isi Ringkas<br/> File</th>
                                        <th width="24%">Asal Telegram Masuk</th>
                                        <th width="18%">No. Telegram Masuk<br/>Tgl Telegram Masuk</th>
