                ...
                echo '
                    <div class="row jarak-form">
                        <ul class="collapsible white" data-collapsible="accordion">
                            <li>
                                <div class="collapsible-header white"><i class="material-icons md-prefix md-36">expand_more</i><span class="add">Tampilkan detail data nota dinas keluar</span></div>
                                        ...
                                        <div class="col m12 white">
                                            <table>
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td width="13%">Tujuan Nota Dinas Keluar</td>
                                                        <td width="1%">:</td>
                                                        <td width="86%">'.$row['tujuan'].'</td>
                                                    </tr>
                                                    <tr>
                                                        <td width="13%">No. Nota Dinas Keluar</td>
                                                        <td width="1%">:</td>
                        ...
                        if(empty($row['file'])){
                            ...
                            if(in_array($eks, $ekstensi) == true){
                                echo '<img class="gbr" data-caption="'.date('d M Y', strtotime($row['tgl_catat'])).'" src="./upload/nota_dinas_keluar/'.$row['file'].'"/>';
                            } else {
                                                ...
                                                <div class="col s9 left">
                                                    <div class="card">
                                                        <div class="card-content">
                                                            <p>File lampiran nota dinas keluar ini bertipe <strong>document</strong>, silakan klik link dibawah ini untuk melihat file lampiran tersebut.</p>
                                                        </div>
                                                        <div class="card-action">
                                                            <strong>Lihat file :</strong> <a class="blue-text" href="./upload/nota_dinas_keluar/'.$row['file'].'" target="_blank">'.$row['file'].'</a>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col s12">
                                                <div class="col s9 left">
                                                    <div class="card">
                                                        <div class="card-content">
                                                            <p>File lampiran nota dinas keluar ini bertipe <strong>PDF</strong>, silakan klik link dibawah ini untuk melihat file lampiran tersebut.</p>
                                                        </div>
                                                        <div class="card-action">
                                                            <strong>Lihat file :</strong> <a class="blue-text" href="./upload/nota_dinas_keluar/'.$row['file'].'" target="_blank">'.$row['file'].'</a>
                                                        </div>
