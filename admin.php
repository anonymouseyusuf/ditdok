        ...
        if(isset($_REQUEST['page'])){
            ...
            switch ($page) {
                case 'tsm':
                    ...
                    break;
                case 'ndm':
                    include "transaksi_nota_dinas_masuk.php";
                    break;
                case 'tm':
                    include "transaksi_telegram_masuk.php";
                    break;
                case 'ctk':
                ...
                case 'tsk':
                    ...
                    break;
                case 'ndk':
                    include "transaksi_nota_dinas_keluar.php";
                    break;
                case 'tk':
                    include "transaksi_telegram_keluar.php";
                    break;
                case 'asm':
                    include "agenda_surat_masuk.php";
                    break;
                case 'anm':
                    include "agenda_nota_dinas_masuk.php";
                    break;
                case 'atm':
                    include "agenda_telegram_masuk.php";
                    break;
                case 'ask':
                    include "agenda_surat_keluar.php";
                    break;
                case 'ank':
                    include "agenda_nota_dinas_keluar.php";
                    break;
                case 'atk':
                    include "agenda_telegram_keluar.php";
                    break;
                case 'ref':
                ...
                case 'gsm':
                    ...
                    break;
                case 'gnm':
                    include "galeri_nm.php";
                    break;
                case 'gtm':
                    include "galeri_tm.php";
                    break;
                case 'gsk':
                    include "galeri_sk.php";
                    break;
                case 'gnk':
                    include "galeri_nk.php";
                    break;
                case 'gtk':
                    include "galeri_tk.php";
                    break;
            }
        } else {
    ?>
        ...
        <div class="row">
            ...
            <?php
                ...
                //menghitung jumlah nota dinas masuk
                $count6 = mysqli_num_rows(mysqli_query($config, "SELECT * FROM tbl_nota_dinas_masuk"));

                //menghitung jumlah telegram masuk
                $count8 = mysqli_num_rows(mysqli_query($config, "SELECT * FROM tbl_telegram_masuk"));

                //menghitung jumlah surat masuk
                $count2 = mysqli_num_rows(mysqli_query($config, "SELECT * FROM tbl_surat_keluar"));

                //menghitung jumlah nota dinas keluar
                $count7 = mysqli_num_rows(mysqli_query($config, "SELECT * FROM tbl_nota_dinas_keluar"));

                //menghitung jumlah telegram masuk
                $count9 = mysqli_num_rows(mysqli_query($config, "SELECT * FROM tbl_telegram_keluar"));
            ...
            <div class="col s12 m4">
                <div class="card cyan">
                    <div class="card-content">
                        <span class="card-title white-text"><i class="material-icons md-36">mail</i> Jumlah Nota Dinas Masuk</span>
                        <?php echo '<h5 class="white-text link">'.$count6.' Nota Dinas Masuk</h5>'; ?>
                    </div>
                </div>
            </div>
            ...
            <div class="col s12 m4">
                <div class="card lime darken-1">
                    <div class="card-content">
                        <span class="card-title white-text"><i class="material-icons md-36">drafts</i> Jumlah Nota Dinas Keluar</span>
            ...
            <div class="col s12 m4">
                <div class="card cyan">
                    <div class="card-content">
                        <span class="card-title white-text"><i class="material-icons md-36">mail</i> Jumlah Telegram Masuk</span>
                        <?php echo '<h5 class="white-text link">'.$count8.' Telegtam Masuk</h5>'; ?>
                    </div>
                </div>
            </div>
            ...
            <div class="col s12 m4">
                <div class="card lime darken-1">
                    <div class="card-content">
                        <span class="card-title white-text"><i class="material-icons md-36">drafts</i> Jumlah Telegram Keluar</span>
                        <?php echo '<h5 class="white-text link">'.$count9.' Telegram Keluar</h5>'; ?>
                    </div>
                </div>
            </div>
