    ...
    if(empty($_SESSION['admin'])){
        ...
        if(isset($_REQUEST['submit'])){
            ...
            if($_REQUEST['dari_tanggal'] == "" || $_REQUEST['sampai_tanggal'] == ""){
                header("Location: ./admin.php?page=anm");
                die();
            } else {

                $query = mysqli_query($config, "SELECT * FROM tbl_nota_dinas_masuk WHERE tgl_diterima BETWEEN '$dari_tanggal' AND '$sampai_tanggal'");
                ...
                echo '
                            ...
                            <div class="z-depth-1">
                                <nav class="secondary-nav">
                                    <div class="nav-wrapper blue-grey darken-1">
                                        <div class="col 12">
                                            <ul class="left">
                                                <li class="waves-effect waves-light"><a href="?page=anm" class="judul"><i class="material-icons">print</i> Cetak Agenda Nota Dinas Masuk<a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </nav>
                    ...
                    <div class="row agenda">
                        <div class="col s10">
                            ...
                            <h5 class="hid">AGENDA NOTA DINAS MASUK</h5>';
                            ...
                            <p class="warna agenda">Agenda Nota Dinas Masuk dari tanggal <strong>'.$d." ".$nm." ".$y.'</strong> sampai dengan tanggal <strong>'.$d2." ".$nm2." ".$y2.'</strong></p>
                        </div>
                        <div class="col s2">
                        ...
                        <table class="bordered" id="tbl" width="100%">
                            <thead class="blue lighten-4">
                                <tr>
                                    ...
                                    <th width="18%">Asal Nota Dinas Masuk</th>
                                    <th width="15%">Nomor ND Masuk</th>
                                    <th width="8%">Tanggal<br/> ND Masuk</th>
                            ...
                            if(mysqli_num_rows($query) > 0){
                                ...
                                echo '<tr><td colspan="9"><center><p class="add">Tidak ada agenda nota dinas masuk</p></center></td></tr>';
                            } echo '
                        </table>
                    </div>';
            }
                        ...
                        <div class="z-depth-1">
                            <nav class="secondary-nav">
                                <div class="nav-wrapper blue-grey darken-1">
                                    <div class="col 12">
                                        <ul class="left">
                                            <li class="waves-effect waves-light"><a href="?page=ank" class="judul"><i class="material-icons">print</i> Cetak Agenda Nota Dinas Masuk<a></li>
                                        </ul>
                                    </div>
                                </div>
                            </nav>
