    ...
    if(empty($_SESSION['admin'])){
        ...
        if(isset($_REQUEST['submit'])){
            ...
            if($_REQUEST['dari_tanggal'] == "" || $_REQUEST['sampai_tanggal'] == ""){
                header("Location: ./admin.php?page=ank");
                die();
            } else {

                $query = mysqli_query($config, "SELECT * FROM tbl_nota_dinas_keluar WHERE tgl_catat BETWEEN '$dari_tanggal' AND '$sampai_tanggal'");
                ...
                echo '
                            ...
                            <div class="z-depth-1">
                                <nav class="secondary-nav">
                                    <div class="nav-wrapper blue-grey darken-1">
                                        <div class="col 12">
                                            <ul class="left">
                                                <li class="waves-effect waves-light"><a href="?page=ank" class="judul"><i class="material-icons">print</i> Cetak Agenda Nota Dinas Keluar<a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </nav>
                    ...
                    <div class="row agenda">
                        <div class="col s10">
                            ...
                            <h5 class="hid">AGENDA NOTA DINAS KELUAR</h5>';
                            ...
                            <p class="warna agenda">Agenda Nota Dinas Keluar dari tanggal <strong>'.$d." ".$nm." ".$y.'</strong> sampai dengan tanggal <strong>'.$d2." ".$nm2." ".$y2.'</strong></p>
                        </div>
                        <div class="col s2">
                            ...
                            if(mysqli_num_rows($query) > 0){
                                ...
                                while($row = mysqli_fetch_array($query)){
                                 echo ' <td>'.$row['no_agenda'].'</td>
                                        ...
                                        $y = substr($row['tgl_nota_dinas'],0,4);
                                        $m = substr($row['tgl_nota_dinas'],5,2);
                                        $d = substr($row['tgl_nota_dinas'],8,2);
                                 ...
                                 echo ' </td>
                                    ...
                                    echo '<tr><td colspan="9"><center><p class="add">Tidak ada agenda nota dinas</p></center></td></tr>';
                                } echo '
                            </table>
                        </div>
                        ...
                        <div class="z-depth-1">
                            <nav class="secondary-nav">
                                <div class="nav-wrapper blue-grey darken-1">
                                    <div class="col 12">
                                        <ul class="left">
                                            <li class="waves-effect waves-light"><a href="?page=ask" class="judul"><i class="material-icons">print</i> Cetak Agenda Nota Dinas Keluar<a></li>
                                        </ul>
                                    </div>
                                </div>
                            </nav>
